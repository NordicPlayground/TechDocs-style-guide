...
* For example: *Access is denied* instead of *Access denied.*
...
* For example: Inspect the database to verify **that** all tables, data, and relationships were correctly migrated.
* For example: Select the check box of each folder **that** you want to sync with your desktop.
...
* For example: Empty **the** container.
* For example: **The** empty container.
